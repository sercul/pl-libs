...
;(function($) {
		...
		return this.each(function() {
			...
			$.each(settings.attributes, function(i,attribute){
				settings.attributes[i] = $.extend({
					...
					validateOnBlur : settings.validateOnBlur, // added by TSS
			...
			$.each(settings.attributes, function(i, attribute) {
				if (attribute.validateOnChange) {
					$('#'+attribute.inputID, $form).change(function(){
						...
						// added by TSS:
						if (attribute.validateOnBlur) validate(attribute, true);
						////////////////////////
					})
					// added by TSS:
					// to clear error message from validation of previous field value, when user entered the field for typing
					// a new value
					.focus(function() {
						$.fn.yiiactiveform.updateInput(attribute, null, $form)
					});
					///////////////
				}
	...
	$.fn.yiiactiveform.getInputContainer = function(attribute, form) {
		if(attribute.inputContainer == undefined)
			// changed by TSS:
			// closest('div') was replaced with parent('div')
			return $('#'+attribute.inputID, form).parent('div'); 
		else
	...
	$.fn.yiiactiveform.defaults = {
		...
		validateOnBlur : false, // added by TSS
