...
qq.FileUploaderBasic = function(o){
    this._options = {
        ...
        button: null,
        multiple: true,
		isMultiple: false, // added by Plexisoft (the sense of previous 'multiple' property is not completely clear) - all this needs clean up
        maxConnections: 3,
        // validation
        allowedExtensions: [],
        sizeLimit: 0,
...
qq.FileUploaderBasic.prototype = {
    ...
    _formatFileName: function(name){
        if (name.length > 17){
            name = name.slice(0, 3) + '...' + name.slice(-13);
        }
        return name;
    },
...
qq.FileUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        template: '<div class="qq-uploader">' +
                ...
                '<div class="qq-upload-button btn btn-default">Choose File</div>' +
