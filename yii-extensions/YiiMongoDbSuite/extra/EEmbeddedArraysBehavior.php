...
class EEmbeddedArraysBehavior extends EMongoDocumentBehavior
{
	...
	public function attach($owner)
	{
		...
		// added by Plexisoft:
		// To import automatically the class created by the DbMngr, it is necessary to insert it here.
		// Sometimes, it is not loaded from DbMngr and it is called from attached behaviors on mongo classes.
        Yii::import("common.autogeneratedModelClasses." . $this->arrayDocClassName);
